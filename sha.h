...
#ifndef SHA_BUFFER_SIZE_FOR_INPUT_ITERATOR
#define SHA_BUFFER_SIZE_FOR_INPUT_ITERATOR 1048576  //=1024*1024: default is 1MB memory
#endif
...
void hash256(InIter first, InIter last, OutIter first2, OutIter last2,
		int buffer_size = SHA_BUFFER_SIZE_FOR_INPUT_ITERATOR) {
	hash256_impl(
